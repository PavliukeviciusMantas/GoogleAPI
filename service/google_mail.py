...
class GoogleMail() :
    ...
    our_email = 'pavl.mantas@gmail.com'
    ...
    def send_message(self, to, subject, body) :
        self.service.users().messages().send(userId = "me", body = self.build_message(to, subject, body)).execute()
        print("Message sent")

    def delete_message(self, message) :
        self.service.users().messages().batchDelete(userId = "me", body = {"ids": [message["id"]]}).execute()
